...
const LandingPage = (  {name,name1} ) => {
  ...
  <rect x="0" y="0" width="600" height="1200" fill="url(#linear)" /></svg>
                        ...
                        <div class='wave1'> 
                               <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 5440 320"><path fill="#f3f4f5" fill-opacity="1" d="M0,288L60,256C120,224,240,160,360,133.3C480,107,600,117,720,138.7C840,160,960,192,1080,197.3C1200,203,1320,181,1380,170.7L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
                          </div> 
                          <div class='wave2'> 
                      <svg xml        ns="http://www.w3.org/2000/svg" viewBox="0 0 5440 320"><path fill="white" fill-opacity="1" d="M0,288L60,256C120,224,240,160,360,133.3C480,107,600,117,720,138.7C840,160,960,192,1080,197.3C1200,203,1320,181,1380,170.7L1440,160L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"></path></svg>
                          </div> 
